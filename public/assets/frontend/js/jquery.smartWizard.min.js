    ...
    d.extend(b.prototype, {
            ...
            var i =
                this.options.toolbarSettings.showNextButton !== false
                    ? d("<button></button>")
                          ...
                          .addClass("btn btn-default sw-btn-next myclass")
                          .attr("type", "button")
                    : null;
            var h =
                this.options.toolbarSettings.showPreviousButton !== false
                    ? d("<button></button>")
                          ...
                          .addClass("btn btn-default sw-btn-prev")
                          .attr("type", "button")
                    : null;
            var l = d("<div></div>")
                .addClass(
        ...
        _setEvents: function () {
            ...
            d(this.steps).on("click", function (i) {
                ...
                if (
                    g.options.anchorSettings.enableAnchorOnDoneStep === false &&
                    g.steps.eq(h).parent("li").hasClass("done")
                ) {
                    return true;
                }
                if (h !== g.current_index) {
                    if (
                        g.options.anchorSettings.enableAllAnchors !== false &&
        ...
        _showNext: function () {
            ...
            for (var h = g; h < this.steps.length; h++) {
                if (
                    !this.steps.eq(h).parent("li").hasClass("disabled") &&
                    !this.steps.eq(h).parent("li").hasClass("hidden")
                ) {
                    g = h;
                    break;
                }
        ...
        _showStep: function (g) {
            ...
            if (
                this.steps.eq(g).parent("li").hasClass("disabled") ||
                this.steps.eq(g).parent("li").hasClass("hidden")
            ) {
                return false;
            }
        ...
        _loadStepContent: function (h) {
            ...
            var m =
                n.data("content-url") && n.data("content-url").length > 0
                    ? n.data("content-url")
            ...
            if (
                this.current_index !== null &&
                this._triggerEvent("leaveStep", [g, this.current_index, j]) ===
                    false
            ) {
                return false;
            }
            if (
                m &&
                m.length > 0 &&
                (!n.data("has-content") || !this.options.contentCache)
            ) {
        ...
        _setAnchor: function (g) {
            ...
            this.steps
                .eq(g)
                .parent("li")
                .removeClass("done danger loading")
                .addClass("active");
            return true;
        },
        _setButtons: function (g) {
            if (!this.options.cycleSteps) {
                ...
                if (this.steps.length - 1 <= g) {
                    ...
                    d(".myclass", this.main).attr("type", "submit");
                    d(" .myclass", this.main).removeClass("sw-btn-next");
                } 
                else {
                    d(".sw-btn-next", this.main).removeClass("disabled");
                    d(".sw-btn-next", this.main).attr("type", "button");
                }
            }
            return true;
        },
        ...
        _fixHeight: function (g) {
            if (this.options.autoAdjustHeight) {
                var h =
                    this.steps.eq(g).length > 0
                        ? d(this.steps.eq(g).attr("href"), this.main)
                        : null;
                this.container
                    .finish()
                    .animate(
