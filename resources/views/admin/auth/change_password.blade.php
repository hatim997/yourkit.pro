...
<body>
                                    ...
                                    <form method="POST" action="{{ route('admin.change.password.post') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input
                                                ...
                                                type="password" name="old_password" placeholder="Enter your current password" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input
                                                class="form-control form-control-lg @error('con_password') is-invalid @enderror"
                                                type="password" name="con_password" placeholder="Re-enter new password" />
                                        ...
                                        <div class="d-grid gap-2 mt-3">
                                            <a href="{{ route('admin.dashboard') }}" class="btn btn-secondary waves-effect waves-light">Back</a>
    ...
    <script src="{{ url(asset('assets/admin/css/app.css')) }}"></script>
