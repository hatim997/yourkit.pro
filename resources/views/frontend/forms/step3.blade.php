<div id="step-3" class="">
    <div class="step-bdy">
        <div class="title-prt2">
            <!--<h2>STEP 3</h2>-->
            <p style="text-transform: uppercase;"> Placement Overview</p>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div id="numberPlacementOptions" class="mt-3" style="display: none;">
                    ...
                    @if (in_array(2, $subcategories))
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="is_phone_on_hoodie" checked>
                    ...
                    @if (in_array(1, $subcategories))
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="is_phone_on_t-shirt" checked>
                ...
                <div id="emailPlacementOptions" class="mt-3" style="display: none;">
                    ...
                    @if (in_array(2, $subcategories))
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="is_email_on_hoodie" checked>
                            <label class="form-check-label">Hoodie</label>
                        </div>
                    @endif
                    ...
                    @if (in_array(1, $subcategories))
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="is_email_on_t-shirt" checked>
                            <label class="form-check-label">T-Shirt</label>
                        </div>
                    @endif
                    <hr>
