                            ...
                            <div class="row">
                                ...
                                <div class="custom-fld col-sm-6">
                                    <h4>*Date of birth <span><input class="form-control @error('dob') is-invalid @enderror"
                                                type="date" name="dob" placeholder="Enter your date of birth" value="{{ $user->profile->dob ?? '' }}"></span>
                                    </h4>
                                    @error('dob')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="custom-fld col-sm-6">
                                    <h4>*Location <span><input class="form-control @error('location') is-invalid @enderror"
                                                type="text" name="location" placeholder="Enter your location" value="{{ $user->profile->location ?? '' }}"></span>
                                    </h4>
                                    @error('location')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="custom-fld col-sm-6">
                                    <h4>*Address <span><input class="form-control @error('address') is-invalid @enderror"
                                                ...
                                                placeholder="Enter your complete address" value="{{ $user->profile->address ?? '' }}"></span></h4>
                                    @error('address')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
