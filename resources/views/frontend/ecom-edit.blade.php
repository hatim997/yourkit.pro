                        ...
                        <div class="service-dtls-text">
                            ...
                            <div class="service-steps">
                                ...
                                <div class="prod-details">
                                    ...
                                    <!--</select>-->
<input type="number" class="form-control" name="quantity" id="quantitySelector" value="{{$attr->quantity}}" min="1" max="9999">
...
@push('scripts')
    ...
    //                     imgHtml += `<div class="big-sld-items"><img class="img-fluid" src="${image}" alt=""></div>`;
    //                 });
