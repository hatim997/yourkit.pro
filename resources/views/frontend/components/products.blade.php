    ...
    <div class="container-xxl">
            ...
            <ul class="filter-lst">
                ...
                @empty(!$subcategories)
                    @foreach ($subcategories->where('status', 1) as $subcategory)
                        ...
                        <!--</li>-->
                        <li class="subcategory-filter" data-id="{{ $subcategory->id }}" data-aos="zoom-in"
                ...
                <div class="col-md-4 bundle-item" data-subcategories="{{ $subCatIds }}">
                    ...
                    <div class="pro-bx" style="height: 470px" data-aos-duration="1000">
                        ...
                        <div class="select-overlay">
                            <a href="{{ route('frontend.product.page', ['meta' => $bundle->uuid]) }}"
                                class="btn btn-outline-warning">Select <i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            @empty
        ...
        @if (request()->routeIs('frontend.home'))
            <div class="text-center mt-4">
                <a href="{{ route('frontend.product') }}" class="btn btn-outline-warning">View All <i
