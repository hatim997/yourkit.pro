        ...
        <div class="container mt-">
            ...
            <form id="multi-step-form">
                <div class="step step-1">
                    ...
                    <h3>Step 1</h3>
                    <div class="mb-3">
                        @include('frontend.forms-edit.step1')
                    </div>
                ...
                <div class="step step-2">
                    ...
                    <h3>Step 2</h3>
                    <div class="mb-3">
                        @include('frontend.forms-edit.step2')
                    </div>
                    <div class="stpBtn">
                ...
                <div class="step step-3">
                    ...
                    <h3>Step 3</h3>
                    <div class="mb-3">
                        @include('frontend.forms-edit.step3')
                    </div>
                    <div class="stpBtn">
                        <button type="button" class="btn btn-outline-warning  prev-step">Previous</button>
...
@push('scripts')
    <script src="{{ url(asset('assets/frontend/js/stepper.js?v='.\App\Utils\Helper::getCssVersion())) }}"></script>
