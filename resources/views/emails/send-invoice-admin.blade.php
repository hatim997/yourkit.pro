<html amp4email="" amp-version="2406131415000" class="i-amphtml-singledoc i-amphtml-standalone i-amphtml-iframed">
...
<body
	style="word-spacing: normal; background-color: rgb(250, 245, 255); opacity: 1; visibility: visible; animation: auto ease 0s 1 normal none running none;"
	class="amp-mode-mouse">
	<div style="background-color:#faf5ff">
		<!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
		<div style="background-color:#fff; margin:0 auto; width:600px">
					...
					<tr>
						<td
							...
							<div style="background:#fff;background-color:#fff;margin:0 auto;max-width:600px">
								<table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
									style="background:#fff;background-color:#fbf6f6;width:100%">
									<tbody>
										<tr>
											<td
												style="border:undefined solid undefined;direction:ltr;font-size:0;padding:20px 0;padding-bottom:10px;padding-left:20px;padding-right:20px;padding-top:10px;text-align:center">
												...
												<div class="mj-column-per-100 mj-outlook-group-fix"
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tbody>
															<tr>
																<td
																	style="background-color:transparent;border:0 solid undefined;vertical-align:top;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
																	<table border="0" cellpadding="0" cellspacing="0"
																		role="presentation" width="100%">
																		<tbody>
																			<tr>
																							...
																							<tr>
																								<td style="width:180px">
																									<amp-img
																										...
																										src="{{$siteLogo}}"
																										style="border: 0px solid transparent; border-radius: 0px; display: block; outline: 0px; text-decoration: none; width: 100%; font-size: 13px; --loader-delay-offset: 134ms !important;"
																										layout="responsive"
																										...
																										i-amphtml-layout="responsive"><i-amphtml-sizer
																											slot="i-amphtml-svc"
																											style="padding-top: 50%;"></i-amphtml-sizer><img style="object-fit: contain;"
																											decoding="async"
																											alt="Alternate image text"
																											src="{{$siteLogo}}"
							...
							<div style="background:#fff;background-color:#fff;margin:0 auto;max-width:600px">
								<table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
									...
									<tbody>
										<tr>
											<td
												style="border:0 solid #1e293b;direction:ltr;font-size:0;padding:20px 0;padding-bottom:40px;padding-left:30px;padding-right:30px;padding-top:20px;text-align:center">
																...
																<td align="left"
																	...
																	<div
																		...
																		<p style="text-align:justify"><span
																				style="font-size:36px">Invoice</span></p>
																		<p style="text-align:justify">&nbsp;</p>
																		<p style="text-align:justify"><span
																				style="font-size:16px">Hello
																				Admin,</span></p>
																		<p style="text-align:justify">&nbsp;</p>
																		<p style="text-align:justify"><span
																				style="font-size:16px">
                                                                                An order has been placed with  order no # {{$order->orderID}}, on {{$order->created_at->format("M d, Y")}} by {{$user->name}}.
																			</span>
                                                                        </p>
																		<p style="text-align:justify">&nbsp;</p>
																		<p style="text-align:justify"><span
																				style="font-size:16px">
                                                                                Total Amount: {{round($order->final_amount, 2)}}
																			</span>
                                                                        </p>
																		<p style="text-align:justify">&nbsp;</p>
																		<p style="text-align:justify"><span
															...
															<tr>
																<td align="center"
																	...
																	<table border="0" cellpadding="0" cellspacing="0"
																		...
																		<tbody>
																			<tr>
																				<td align="center" bgcolor="#EB4747"
																					role="presentation"
																					style="border-radius:4px;border:0 solid none;cursor:auto;height:auto;background:#3B7352;padding:0">
																					<a href="{{$invoiceLink}}"
																						style="display:inline-block;background:#3B7352;color:#fff;font-family:Helvetica;font-size:16px;font-weight:400;line-height:1;letter-spacing:1px;margin:0;text-decoration:none;text-transform:none;padding:12px 24px 12px 24px;border-radius:4px"
																						target="_blank"><strong>Download Invoice</strong></a></td>
																			</tr>
																		</tbody>
																	</table>
																</td>
							...
							<div style="background:#fff;background-color:#fff;margin:0 auto;max-width:600px">
								<table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
									...
									<tbody>
										<tr>
											<td
												style="border:0 solid #1e293b;direction:ltr;font-size:0;padding:20px 0;padding-bottom:0;padding-left:50px;padding-right:50px;padding-top:0;text-align:center">
																	...
																	<table border="0" cellpadding="0" cellspacing="0"
																		...
																		<tbody>
																			<tr>
																				...
																				<td
																					style="font-size:0;padding:10px 25px;padding-top:10px;padding-right:0;padding-bottom:10px;padding-left:0;word-break:break-word">
																					<p
																						style="border-top:solid 1px #eb4747;font-size:1px;margin:0 auto;width:100%">
																					</p><!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" style="border-top:solid 1px #EB4747;font-size:1px;margin:0px auto;width:500px;" role="presentation" width="500px" ><tr><td style="height:0;line-height:0;"> &nbsp;
</td></tr></table><![endif]-->
																				</td>
							...
							<div style="background:0 0;background-color:transparent;margin:0 auto;max-width:600px">
								<table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
									...
									<tbody>
										<tr>
											<td
												style="border:0 solid #1e293b;direction:ltr;font-size:0;padding:20px 0;padding-bottom:30px;padding-left:20px;padding-right:20px;padding-top:20px;text-align:center">
												<!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td align="left" class="" style="vertical-align:top;width:560px;" ><![endif]-->
												<div class="mj-column-per-100 mj-outlook-group-fix"
													style="font-size:0;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%">
													<table border="0" cellpadding="0" cellspacing="0"
														role="presentation"
														...
														<tbody>
															<tr>
																<td align="center"
																	style="font-size:0;padding:10px 25px;padding-top:12px;padding-right:0;padding-bottom:12px;padding-left:0;word-break:break-word">
															...
															<tr>
																<td align="left"
																	style="font-size:0;padding:10px 25px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:5px;word-break:break-word">
																	<div
																		style="font-family:Helvetica;font-size:14px;font-weight:400;letter-spacing:.4px;line-height:1.4;text-align:left;color:#444">
															...
															<tr>
																<td
																	...
																	<!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td height="24" style="height:24px;"><![endif]-->
															...
															<tr>
																<td align="left"
																	style="font-size:0;padding:10px 25px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:5px;word-break:break-word">
																	<div
																		style="font-family:Helvetica;font-size:12px;font-weight:400;letter-spacing:.4px;line-height:1.4;text-align:left;color:#444">
																		<p style="text-align:center"></p>
																	</div>
																</td>
															</tr>
	...
	</div><amp-img width="1" height="1" alt="signature"
		src="https://tracker.mailmodo.email/opens/web/f28870a9-ec3f-416c-aad7-d6dfdf6b1cb5/sampleRecipientIdFromWebsite"
