...
class SettingController extends Controller
{
    ...
    public function updateCompanySettings(Request $request, $id)
    {
        ...
        $validate = Validator::make($request->all(), [
            ...
            'site_phone' => 'nullable|numeric', // Changed from integer
        ...
        try {
            ...
            $companySetting->site_email = $request->site_email;
            $companySetting->site_phone = $request->site_phone;
            ...
            $companySetting['contact-map'] = $request['contact-map'];
